...
<!-- Img -->
[Drag and drop the InputManager](https://)
...
<!-- Img -->
![Create 3D Plane with “Finish” tag](https://)

<!-- Img -->
![Change the transform values and turn off mesh renderer](https://)
...
<!-- Img -->
![GameController parent of SpatialMapping](https://) 
